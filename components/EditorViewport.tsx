...
import { AppMode, DrawTool } from "../types";
      ...
      {image ? (
        ...
        <div className="flex flex-col items-center text-center max-w-md px-4 py-12 animate-in fade-in zoom-in duration-500">
          <div className="w-16 h-16 md:w-24 md:h-24 bg-indigo-600/10 rounded-2xl md:rounded-[2.5rem] flex items-center justify-center mb-6 md:mb-8 border border-indigo-500/20 shadow-inner">
            <svg
              className="w-8 h-8 md:w-10 md:h-10 text-indigo-500"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold mb-3 md:mb-4 tracking-tight">
            Studio Lumina
          </h2>
          <p className="text-slate-400 mb-8 md:mb-10 leading-relaxed text-xs md:text-sm">
            Professional AI image suite. Toggle between efficient Flash and
            powerful Pro engines.
          </p>
